...
INSERT INTO `api_site_templates` VALUES
  ('1','Base','base','Базовый шаблон вывода данных (только контент)','0','2','','0','[*content*]','0','1','0','1659863206'),
  ('2','Main','main','Шаблон для отображения HTML разметки','0','2','','0','<!DOCTYPE html>\n<html>\n	{{html-head?\n		&color=`#333`\n	}}\n<body data-page-id=\"[*id*]\" data-page-parent=\"[*parent*]\">\n	<main id=\"page\">\n		{{header}}\n		<article id=\"content-wrapper\">\n			<section id=\"page-content\">[*content*]</section>\n			{{sections}}\n		</article>\n		{{footer}}\n	</main>\n	{{page-assets}}\n	{{seo-assets}}\n</body>\n</html>','0','1','1659863502','1659869199');
...
INSERT INTO `api_site_tmplvars` VALUES
  ('1','dropdown','meta-state','Значение meta-тега Document-state','Значение «Static» отмечает, что системе нет необходимости индексировать документ в дальнейшем, «Dynamic» позволяет регулярно индексировать Интернет-страницу.','0','6','0','Static||Dynamic','0','custom_widget','&output=<meta name%3D\"document-state\" content%3D\"[+value+]\" />','Dynamic','1659875003','1659875003','[]'),
  ('2','dropdown','meta-robots','Значение meta-тега Robots','<b>index, follow</b> &ndash; индексировать страницу и следовать по ссылкам','0','6','0','index,follow||\nnoindex,nofollow||\nindex,nofollow||\nnoindex,follow','0','custom_widget','&output=<meta name%3D\"robots\" content%3D\"[+value+]\" />','index,follow','1659875070','1659875120','[]'),
  ('3','textareamini','meta-keywords','Ключевые слова','отображаются в соответствующем meta-теге','0','6','0','','0','','','','1659875223','1659875301','[]');
